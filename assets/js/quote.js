$(document).ready(function () {
    ...
    function getProdRange() {
        ...
        if ($("#standard").is(":checked")) {
            ...
            (prodRange.type = null), (prodRange.price = null), (prodRange.installationFeePercentage = null);
            return prodRange;
        }
    }
    ...
    function setRequiredElevatorsResult(finNumElev) {
        $("#numElev_2, #numElev_3").val(finNumElev);
    }
    parseFloat;

    function setPricesResults(caca, roughTotal, installFee, total) {
